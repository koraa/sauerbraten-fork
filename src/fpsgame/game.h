...
enum
{
	...
	N_LISTPACKS, N_PACKLIST, //a list of accessible contentpacks on the server 
	N_GETPACKFILES, N_PACKFILES,//receive a list of files in this specific contentpack (usually the map, its textures, sounds and mapmodels) 
	N_GETFILE, N_SENDFILE,	 //the client requests the specific files individually
...
static const int msgsizes[] =               // size inclusive message token, 0 for variable or not-checked sizes
{
    ...
    N_LISTPACKS, 2, N_PACKLIST, 0, 
	N_GETPACKFILES, 2, N_PACKFILES, 0,
	N_GETFILE, 3, N_SENDFILE, 0,
